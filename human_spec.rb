...
RSpec.describe Human do 
	describe "initialization" do 
		# before running any of the tests below ...
		before do 
			@human = Human.new
		end
		...
		it "has a defualt stealth value of 3" do 
	...
	describe "attributes" do 
		...
		it "has a getter and a setter for strength" do 
			@human.strength = 0
			expect(@human.strength).to eq(0)
		end
		it "has a getter and a setter for intelligence" do 
			@human.intelligence = 0
			expect(@human.intelligence).to eq(0)
		end
		it "has a getter and a setter for stealth" do 
			@human.stealth = 0
			expect(@human.stealth).to eq(0)
		end
		it "has a getter and a setter for health" do 
			@human.health = 0
